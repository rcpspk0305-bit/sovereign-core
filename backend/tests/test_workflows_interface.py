"""Unit tests for workflows interface and deterministic local engine."""
...
@pytest.mark.asyncio
async def test_deterministic_workflow_execution():
    engine = DeterministicLocalWorkflowEngine()
...
@pytest.mark.asyncio
async def test_workflow_step_budget_enforcement():
    engine = DeterministicLocalWorkflowEngine()
